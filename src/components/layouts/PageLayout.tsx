...
const PageLayout = ({  global, children,name}: Props) => {
  return (
    <>
      ...
      <BannerSlide  timezone={global.timezone} name={name} hours={global.hours}BackgroundImage={global.c_bannerPhoto}  c_cTAForBanner={global.c_bannerCta} c_bannerSlogan={global.c_bannerSlogan}/>
      {children}
