...
const PageLayout = ({  global, children,timezone ,name,hour}: Props) => {
  return (
    <>
      ...
      <BannerSlide  timezone={timezone} name={name} hours={hour}BackgroundImage={global.c_bannerPhoto}  c_cTAForBanner={global.c_bannerCta} c_bannerSlogan={global.c_bannerSlogan}/>
      {children}
